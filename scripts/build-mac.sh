...
cmake --build build-mac --config Release --target HaviRadio_VST3 HaviRadioDSPTests RadioBoxBehaviorTests --parallel 2
ctest --test-dir build-mac -C Release --output-on-failure
plugin='build-mac/HaviRadio_artefacts/Release/VST3/RadioBox.vst3'
